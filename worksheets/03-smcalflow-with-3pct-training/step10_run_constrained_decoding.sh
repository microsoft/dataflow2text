...
model_loc="models/codet5-base-finetuned-3pct"
processed_data_dir="../01-smcalflow/output/step02_process_data"
grammar_base_dir="../01-smcalflow/output/step01_create_cfg_productions"
